...
import { VoiceChatContent } from "../content/VoiceChatContent";
import { FaAngleDown } from "react-icons/fa";
import { MusicPlayingSimulation } from "./MusicPlayingSimulation";
  ...
  return (
    <div>
      ...
      >
        ...
        >
          {(isInitial === "initial"
            ? VoiceChatContent.filter((voice) => voice.initial === true)
            : VoiceChatContent
          ).map((voice) => {
            return (
              <motion.div
                ...
                <motion.div layout className="flex flex-col items-center">
                  <div className="bg-white bx-shadow-light relative rounded-full p-[0.09rem]">
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${voice.picture})`,
                      }}
                    ></div>
                  </div>
                </motion.div>

  ...
  return (
    <Card className="max-h-[22rem] min-h-[22rem] bg-inherit border-none text-inherit flex flex-col justify-center">
      <CardHeader className="pb-3">
        <CardTitle className="text-[1.2rem] text-white">Share this portfolio</CardTitle>
      ...
      <CardContent>
        <div className="flex gap-2">
          ...
          <Input
            ...
            readOnly
          />
          <Button className="shrink-0 bg-[#27272A] hover:bg-inherit">Copy Link</Button>
        </div>
            ...
            <div className="flex items-center justify-between space-x-4">
              <div className="flex items-center space-x-4">
                <Avatar >
                  ...
                  <AvatarFallback className="bg-[#27272A] text-white">JM</AvatarFallback>
                </Avatar>
                <div>
              ...
              <Select defaultValue="edit">
                <SelectTrigger className="ml-auto w-[110px] bg-[#222222] border-none" aria-label="Edit">
            ...
            <div className="flex items-center justify-between space-x-4">
              <div className="flex items-center space-x-4">
                <Avatar>
                  ...
                  <AvatarFallback className="bg-[#27272A] text-white">MS</AvatarFallback>
                </Avatar>
                <div>
                  <p className="text-sm font-medium leading-none">
                    Morgan Stones

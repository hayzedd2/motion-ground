...
export const AboutMe = () => {
    return (
      <>
        <div className="px-4 pt-20 flex flex-col gap-1 opacity-80 text-[1.1rem]">
          ...
          <a href="https://www.alhameen.xyz/" target="_blank" className="w-full  flex items-end justify-end underline underline-offset-2">See my portfolio</a>
        </div>
